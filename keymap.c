 ...
 */
  [HIRAGANA] = LAYOUT(
    ...
    MO(HIRAGANA_SUPP), KC_Z         , KC_NO  , KC_C         , KC_V    , KC_B           , UC(HRGN_N), KC_M         , KC_COMM      , KC_DOT        , KC_SLSH           , RSFT_T(KC_ENT) , 
  ...
  [KATAKANA] = LAYOUT(
    ...
    MO(KATAKANA_SUPP), KC_Z         , KC_NO  , KC_C         , KC_V    , KC_B           , UC(KTKN_N), KC_M         , KC_COMM      , KC_DOT        , KC_SLSH           , RSFT_T(KC_ENT) , 
                                               KC_LALT      , MO(FN)  , KC_SPC         , MO(FN)    , KC_RGUI
  ),
  ...
  [KATAKANA_SUPP] = LAYOUT(
    ...
    KC_LCTL          , UC(KTKN_A_SM), KC_S   , KC_D         , KC_F    , KC_G           , KC_H      , KC_J         , KC_K         , KC_L          , UC(SYM_HANDAKUTEN), TO(FN)         , 
  ...
  [FN] = LAYOUT(
    ...
    KC_LCTL          , UC(KTKN_A_SM), KC_LEFT, KC_DOWN      , KC_RIGHT, KC_NO        , UC(JP_NUM_4), UC(JP_NUM_5) , UC(JP_NUM_6) , KC_NO         , KC_NO             , TO(HIRAGANA)   , 
    MO(KATAKANA_SUPP), KC_NO        , KC_NO  , KC_C         , KC_V    , KC_NO        , UC(JP_NUM_7), UC(JP_NUM_9) , UC(JP_NUM_9) , UC(SYM_PERIOD), KC_NO             , RSFT_T(KC_ENT) , 
                                               KC_LALT      , KC_NO   , KC_SPC       , KC_TRNS     , UC(SYM_LONGVOW)
  ),
